...
def save_max_like_params_per_split_single_epoch():
    likelihoods_path = os.path.join('SavedOutputs', 'ReciprocalModel', 'DyadsSplit', 'likelihoods', 'SingleDevStage')
    out_path = os.path.join('SavedOutputs', 'ReciprocalModel', 'DyadsSplit',
...
def save_max_like_params_per_split_three_epochs():
    likelihoods_path = os.path.join('SavedOutputs', 'ReciprocalModel', 'DyadsSplit', 'likelihoods', 'ThreeDevStages')
    out_path = os.path.join('SavedOutputs', 'ReciprocalModel', 'DyadsSplit',
